...
const insertHousehold = async (householdData, dbClient) => {
  const query = `
    ...
    VALUES (
      ...
      $21, $22, $23, $24, COALESCE($25::timestamptz, NOW()), NOW(), $26
    )
    RETURNING
      id,
      disaster_event_id,
  ...
  const values = [
    ...
    householdData.family_head_photo_path || null,
    householdData.family_head_photo_sha256 || null,
    householdData.family_head_photo_mime_type || null,
    householdData.family_head_photo_size_bytes ?? null,
...
const replaceHouseholdRegistrationAuthority = async (
  ...
  const query = `
    ...
    SET
      ...
      family_head_photo_path = COALESCE($18, family_head_photo_path),
      family_head_photo_sha256 = COALESCE($19, family_head_photo_sha256),
      family_head_photo_mime_type = COALESCE($20, family_head_photo_mime_type),
      family_head_photo_size_bytes = COALESCE($21, family_head_photo_size_bytes),
      photo_captured_at = $22,
      photo_captured_by = $23,
      photo_verification_notes = $24,
      registered_at = $25::timestamptz,
      updated_at = NOW()
    WHERE id = $1
      AND is_active = TRUE
    RETURNING
