...
const upsertUserRoleSettings = async (
  ...
  const query = `
    ...
    SET profile_picture_data_url = EXCLUDED.profile_picture_data_url,
        ...
        last_local_password_change_at = EXCLUDED.last_local_password_change_at,
        last_two_factor_preference_update_at =
          EXCLUDED.last_two_factor_preference_update_at,
  ...
  const result = await dbClient.query(query, [
    ...
    preferredExportFormat,
    twoFactorEnabled,
    lastLocalPasswordChangeAt || null,
    lastTwoFactorPreferenceUpdateAt || null,
