...
const panelStyle = { position: "fixed", left: "var(--offline-ready-left, 50%)", right: "var(--offline-ready-right, auto)", bottom: "max(16px, env(safe-area-inset-bottom))", transform: "var(--offline-ready-transform, translateX(-50%))", zIndex: 1200, width: "min(390px, calc(100vw - 32px))", maxHeight: "calc(100dvh - 32px - env(safe-area-inset-bottom))", overflowY: "auto", boxSizing: "border-box", padding: "18px", border: "1px solid #cbdbea", borderRadius: "16px", background: "#fff", boxShadow: "0 14px 36px rgba(31,64,96,.2)" };
